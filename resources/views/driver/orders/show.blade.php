...
$opsRoleLabel = 'Driver';
$opsNavItems = [
    ['url' => route('driver.dashboard'), 'icon' => '🏠', 'label' => 'Beranda', 'active' => false],
    ['url' => route('driver.orders.index'), 'icon' => '🚚', 'label' => 'Antar', 'active' => true],
    ['url' => route('driver.cash.index'), 'icon' => '💵', 'label' => 'Setoran', 'active' => false],
];
@endphp
